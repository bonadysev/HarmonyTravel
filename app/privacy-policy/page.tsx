      ...
      <div className="section-shell">
        <div className="mx-auto max-w-4xl rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-[0_24px_80px_rgba(23,32,51,0.08)] sm:p-8 lg:p-10">
          ...
          <div className="mt-8 grid gap-8 text-sm leading-7 text-[color:var(--ink-soft)] sm:text-base">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-black text-[color:var(--foreground)]">7. Права пользователя</h2>
              <ul className="space-y-2">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-black text-[color:var(--foreground)]">8. Как отозвать согласие</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-black text-[color:var(--foreground)]">9. Использование cookie</h2>
              <p>
                На сайте не используются собственные cookie-файлы для отслеживания пользователей. При
                переходе на внешние сервисы, такие как Formspree, Telegram, Instagram или Google Maps,
                могут применяться правила и технологии этих сервисов.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-black text-[color:var(--foreground)]">10. Рекламные рассылки</h2>
              <p>
